<!-- universal delete dialog -->
<div x-data="{open: @entangle('show').defer}">
    <div @click="open=true">
        <i class="fa fa-trash text-red-400"></i>
    </div>

    <div x-show="open" x-transition style="display: none;" id="popup-modal" tabindex="-1" class="fixed overflow-y-auto overflow-x-hidden top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full">
        <div class="max-w-sm m-auto top-1/3 relative bg-white rounded-lg shadow dark:bg-gray-700">
